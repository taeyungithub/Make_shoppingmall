        ...
        <div class="card-body p-4">
          ...
          <form method="post" action="/mypage/updateProductAction.do">
            ...
            <div class="form-floating mb-3">
              <input type="text" name="product_name" class="form-control" id="product_name" placeholder="상품 이름">
              <label for="product_name">상품 이름 수정</label>
            </div>

            <div class="form-floating mb-3">
              <input type="text" name="product_image" class="form-control" id="product_image" placeholder="상품 사진"
                     required>
              <label for="product_image">상품 사진 수정</label>
            </div>

            <div class="form-floating mb-3">
              <input type="text" name="product_price" class="form-control" id="product_price" placeholder="상품 가격"
                     required>
